...
export default function HeroPage(){
    return (
        ...
        <div data-aos="fade-right" className="md:w-[60%] w-[80%] pl-[5%]">
...
<div data-aos="fade-right" className="bg-[rgba(255,210,164,0.2)] py-6 px-8  border-b-8 border-[#FFD2A4] flex flex-col gap-2 w-[95%] md:w-[80%] h-96">
<div className='bg-[#FFD2A4] p-3 w-fit rounded-full'><FaHeart size={23} className=''/></div> 
    ...
    <div data-aos="fade-down" className="bg-[rgba(255,210,164,0.2)] py-6 px-8  border-b-8 border-[#FFD2A4]  flex flex-col gap-2 w-[95%] md:w-[80%] h-96">
...
<div data-aos="fade-up" className="bg-[rgba(255,210,164,0.2)] py-6 px-8  border-b-8 border-[#FFD2A4] flex flex-col gap-2 w-[95%] md:w-[80%] h-96">
